...
<div align="center">
  <h1 style="font-size: 36px; color: #FFA500;">🌟 Welcome to My GitHub Profile 🌟</h1>
  <hr style="border: 2px solid #FFA500; width: 80%;">
</div>

<div align="center">
  <h2 style="font-size: 32px; color: #FF4500;">👋 Hi, I'm Sanket</h2>
  <ul style="list-style: none; text-align: left; font-size: 20px; color: #2F4F4F;">
    <li>🎓 <b>Final Year Electronics and Telecommunication (ENTC) Engineering Student</b></li>
    <li>🧠 Passionate about <b>Machine Learning, Web Development,</b> and <b>Healthcare Technology</b></li>
    <li>🌟 Currently a <b>Web Development Intern at <a href="https://www.labdox.com" style="color: #4682B4;">Labdox</a></b></li>
    <li>🔭 Working on innovative projects that bridge the gap between technology and real-world applications</li>
  </ul>
...
<div align="left">
  ...
  <ul style="list-style-type: disc; margin-left: 40px; color: #2F4F4F; font-size: 18px;">
    <li><b>Tech Stack:</b> Arduino, Sensors, Buzzer</li>
    <li><b>Highlights:</b></li>
    <ul style="list-style-type: circle; margin-left: 20px;">
      <li>📅 Timely alerts for medication</li>
  ...
  <ul style="list-style-type: disc; margin-left: 40px; color: #2F4F4F; font-size: 18px;">
    <li><b>Tech Stack:</b> React.js, Vite, Tailwind CSS</li>
    <li><b>Highlights:</b></li>
    <ul style="list-style-type: circle; margin-left: 20px;">
  ...
  <ul style="list-style-type: disc; margin-left: 40px; color: #2F4F4F; font-size: 18px;">
    ...
    <li><b>Highlights:</b></li>
    <ul style="list-style-type: circle; margin-left: 20px;">
      <li>🏅 Top 5 performers displayed with medals</li>
      <li>🎨 Customizable colors and layout</li>
  ...
  <ul style="list-style-type: disc; margin-left: 40px; color: #2F4F4F; font-size: 18px;">
    <li><b>Tech Stack:</b> React.js, Node.js, MongoDB, Express.js</li>
    <li><b>Highlights:</b></li>
    <ul style="list-style-type: circle; margin-left: 20px;">
      <li>🛒 User-friendly interface for browsing and purchasing books</li>
      <li>📈 Admin panel for managing inventory</li>
  ...
  <ul style="list-style-type: disc; margin-left: 40px; color: #2F4F4F; font-size: 18px;">
    <li><b>Tech Stack:</b> Power BI, JavaScript, SQL</li>
    <li><b>Highlights:</b></li>
    <ul style="list-style-type: circle; margin-left: 20px;">
...
<div align="center">
  ...
  <ul style="list-style-type: square; text-align: left; color: #2F4F4F; font-size: 18px;">
    ...
    <li>🌟 Using Power BI for data visualization</li>
